...
export class ConvenioService {
  ...
  getAll(): Observable<Convenio[]> {
    return this.http
      .get<Convenio[]>(this.baseUrl + 'convenios/', {
  ...
  getById(id): Observable<Convenio> {
    return this.http
      .get<Convenio>(this.baseUrl + 'convenios/' + id + '/', {
        headers: this.httpHeaders,
      })
  ...
  update(convenio): Observable<any> {
    return this.http.put(
      this.baseUrl + 'convenios/' + convenio.id + '/',
      convenio,
      { headers: this.httpHeaders }
    );
  }
  ...
  save(convenio) {
    return this.http.post(this.baseUrl + 'convenios/', convenio, {
      headers: this.httpHeaders,
    });
  }
  ...
  getByNome(nome): Observable<any> {
    return this.http.get(this.baseUrl + 'convenio/nome/' + nome + '/', {
      headers: this.httpHeaders,
    });
  }
  ...
  getByCnpj(cnpj): Observable<any> {
    return this.http.get(this.baseUrl + 'convenio/cnpj/' + cnpj + '/', {
      headers: this.httpHeaders,
    });
  }
  ...
  getByAns(ans): Observable<any> {
    return this.http.get(this.baseUrl + 'convenio/ans/' + ans + '/', {
      headers: this.httpHeaders,
    });
  }
}
